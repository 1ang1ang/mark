...
/**
 * Created by guoyang on 2017/7/10.
 */
...
//    public static String myEmailAccount = "13426092307@163.com";
//    public static String myEmailPassword = "guoyang";
    ...
    public static void sendMail(String receiveMail, String receiverName, String subject, String content) throws  Exception {
        ...
        */
        ...
        // 3. 创建一封邮件
        MimeMessage message = createMimeMessage(session, receiveMail, receiverName, subject, content);
        ...
        transport.connect(SENDER_MAIL, SENDER_MAIL_PASSWORD);
    ...
    public static void main(String[] args) throws Exception {
        sendMail("iamguoyang@qq.com", "shuai", "testSubject", "testContent");
    }
}
